...
return [
    ...
    'termTemplates' => 'قوالب الشروط',
    'Edit' => 'تعديل',
    'edit_template' => 'تعديل القالب',
    'template_name' => 'اسم القالب',
    'default_laptop_term' => 'الشروط الافتراضية للحاسوب المحمول',
    'change_file' => 'استبدال الملف',
    'current_file' => 'الملف الحالي',
    'leave_it_empty_to_preserve' => 'اتركه فارغاً للاحتفاظ بالملف الحالي',
    'allowed_categories' => 'الفئات المسموح بها',
    'all_categories' => 'جميع الفئات',
    'leave_uncheck_category' => 'اترك جميع الخيارات غير محددة لقبول أي فئة',
    'active_template' => 'القالب النشط',
    'last_generations' => 'آخر عمليات الإنشاء',
    'total' => 'الإجمالي',
    'generated_by' => 'تم الإنشاء بواسطة',
    'new_template' => 'قالب جديد',
    'file' => 'ملف',
    'use' => 'استخدم',
    'in_document_fields' => 'في المستند للحقول الديناميكية',
    'see_var_below' => 'انظر المتغيرات المتاحة أدناه',
    'var_available' => 'المتغيرات المتاحة للقالب',
    'terms_of_responsibility' => 'شروط المسؤولية',
    'registered_templates' => 'القوالب المسجلة',
    'generated' => 'تم الإنشاء',
    'actions' => 'الإجراءات',
    'inactive' => 'غير نشط',
    'active' => 'نشط',
    'no_templates' => 'لم يتم تسجيل أي قوالب بعد',
    'var' => 'متغير',
    'generate_term' => 'إنشاء شرط',
    'template_type' => 'نوع الشرط',
    'gen_download' => 'إنشاء وتنزيل',
    'Keyboards' => 'لوحة المفاتيح',
    'Laptops' => 'حاسوب محمول',
    'Desktops' => 'حاسوب مكتبي',
    'Monitors' => 'شاشة',
    'Charger' => 'شاحن',
    ...
    'no_generation_template' => 'لم يتم تسجيل أي إنشاء لهذا القالب.',
    'select_document_purpose' => 'حدد الغرض من المستند',
    'terms_responsibility' => 'شروط المسؤولية',
    'return_term' => 'شروط الإرجاع',
    'term_checkout'                  => 'شروط التسليم',
    'term_checkin'                   => 'شروط الاستلام',
    'regenerate'                     => 'إعادة إنشاء',
    'generated_at'                   => 'تم الإنشاء في',
    'no_templates_for_category'      => 'لا يوجد قالب متاح لهذه الفئة.',
    'term_checkin_blocked_tooltip'   => 'قم بإنشاء شرط التسليم قبل إنشاء شرط الإرجاع.',
    'term_checkin_requires_checkout' => 'يجب إنشاء شرط التسليم قبل الإرجاع.',
    'term_load_error'                => 'خطأ في تحميل حالة المستند.',
    'term_status_generated' => 'تم الإنشاء',
    'term_status_blocked'   => 'محظور',
